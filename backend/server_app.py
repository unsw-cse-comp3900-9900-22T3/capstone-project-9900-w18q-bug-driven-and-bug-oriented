...
def get_items(order_id):
    ...
    return {"tableNumber":table_time_result[0][0],"orderTime":table_time_result[0][1],"itemList":item_res.to_dict(orient ='records')}
